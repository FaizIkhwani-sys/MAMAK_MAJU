...
import 'package:mamakmajuwebapp/Customers/Orders/submitpage.dart';

class TandooriPage extends StatefulWidget {
  final imgPath, foodName, pricePerItem, heroTag;

  TandooriPage({this.imgPath, this.foodName, this.pricePerItem, this.heroTag});
  @override
          ...
          children: <Widget>[
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Container(
                  ...
                  child: Center(
                      child: Text(
                        '\RM' + (int.parse(widget.pricePerItem) * quantity).toString(),
                        style: TextStyle(
                            fontSize: 40.0,
  ...
  _buildListItem(String columnNumber) {
    return Padding(
        ...
        child: Column(
          children: <Widget>[
            if(columnNumber == '1')
              _buildColumnItem('assets/images/vadey.png', 'Vadey', '0.5', Color(0xFFFBD6F5)),
            if(columnNumber == '1')
              SizedBox(height: 15.0),
            if(columnNumber == '1')
              _buildColumnItem('assets/images/kebab.png', 'Kebab', '5', Color(0xFFFBD6F5)),
            if(columnNumber == '2')
              _buildColumnItem('assets/images/capati.png', 'Capati', '2',
                  Color(0xFFC2E3FE)),
            if(columnNumber == '2')
              SizedBox(height: 15.0),
            if(columnNumber == '2')
              _buildColumnItem('assets/images/karipap.png', 'Karipap', '0.5',
                  Color(0xFFD7FADA)),
          ],
        )
    );
